...
import shop.ebusiness.product.DatabaseHelper.Companion.ID
import shop.ebusiness.product.DatabaseHelper.Companion.anzahl
import shop.ebusiness.product.DatabaseHelper.Companion.bes
import shop.ebusiness.product.DatabaseHelper.Companion.cat
import shop.ebusiness.product.DatabaseHelper.Companion.einh
import shop.ebusiness.product.DatabaseHelper.Companion.einh_anz
import shop.ebusiness.product.DatabaseHelper.Companion.einh_fett
import shop.ebusiness.product.DatabaseHelper.Companion.einh_fol
import shop.ebusiness.product.DatabaseHelper.Companion.einh_preis
import shop.ebusiness.product.DatabaseHelper.Companion.einh_vitC
import shop.ebusiness.product.DatabaseHelper.Companion.fettanteil
import shop.ebusiness.product.DatabaseHelper.Companion.fol
import shop.ebusiness.product.DatabaseHelper.Companion.her
import shop.ebusiness.product.DatabaseHelper.Companion.kalo
import shop.ebusiness.product.DatabaseHelper.Companion.name
import shop.ebusiness.product.DatabaseHelper.Companion.pos1
import shop.ebusiness.product.DatabaseHelper.Companion.pr
import shop.ebusiness.product.DatabaseHelper.Companion.veg
import shop.ebusiness.product.DatabaseHelper.Companion.vege
import shop.ebusiness.product.DatabaseHelper.Companion.vitc
import shop.ebusiness.product.DatabaseHelper.Companion.war
