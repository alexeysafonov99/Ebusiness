 ...
 */
class DatabaseHelper_m(context: Context): SQLiteOpenHelper(context, db_name,null, db_version) {
     ...
     */
    fun getAllFruits():List<shop.ebusiness.product.ProductList>{
        val productList=ArrayList<shop.ebusiness.product.ProductList>()
     ...
     */
    fun getAllPulse():List<shop.ebusiness.product.ProductList>{
        val productList=ArrayList<shop.ebusiness.product.ProductList>()
        val db:SQLiteDatabase=writableDatabase
     ...
     */
    fun getAllProducts():ArrayList<shop.ebusiness.product.ProductList>{
        val productList=ArrayList<shop.ebusiness.product.ProductList>()
        val db: SQLiteDatabase = writableDatabase
     ...
     */
    fun search(keyword: String): List<shop.ebusiness.product.ProductList?>? {
        var products: MutableList<shop.ebusiness.product.ProductList?>? = null
